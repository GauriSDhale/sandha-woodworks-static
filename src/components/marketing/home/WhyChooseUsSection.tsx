            ...
            return (
              ...
              >
                <CountUpStat
                  ...
                  delayMs={index * 120}
                  active={inView}
                  className="[&_p:first-child]:text-5xl [&_p:first-child]:font-light [&_p:first-child]:tracking-tight [&_p:first-child]:text-foreground/35 sm:[&_p:first-child]:text-6xl lg:[&_p:first-child]:text-7xl [&_p:nth-child(2)]:mt-3 [&_p:nth-child(2)]:text-[11px] [&_p:nth-child(2)]:font-medium [&_p:nth-child(2)]:normal-case [&_p:nth-child(2)]:tracking-normal [&_p:nth-child(2)]:text-foreground/80 [&_p:nth-child(2)]:no-underline [&_p:last-child]:mt-1 [&_p:last-child]:text-sm [&_p:last-child]:text-muted-foreground"
                />
