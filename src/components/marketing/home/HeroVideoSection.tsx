...
export function HeroVideoSection() {
  ...
  return (
    <section className="relative h-[100svh] w-full overflow-hidden bg-warm-black">
      ...
      {/* Soft top scrim for nav contrast — keep light so the logo stays clear and no hard band shows */}
      <div className="pointer-events-none absolute inset-x-0 top-0 h-[16vh] bg-[linear-gradient(to_bottom,rgba(0,0,0,0.38)_0%,rgba(0,0,0,0.14)_45%,transparent_100%)]" />
